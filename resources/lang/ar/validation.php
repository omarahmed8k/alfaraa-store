...
return [
    ...
    */
    ...
    'custom' => [
        'password' => [
            'regex' => 'يجب أن تحتوي كلمة المرور على رقم واحد على الأقل وكل من الأحرف الكبيرة والصغيرة.',
        ],
    ],
    ...
    */
    ...
    'attributes'           => [
        ...
        'station_name'          => 'الاسم التجارى للمحطة',
        'street'          => 'الشارع',
        'building_num'          => 'رقم الوحدة',
        'region_num'          => 'رقم المنطقة',
        'active'            => 'مفعل',
        'branch'            => 'الفرع',
        'job_title'         =>  'المسمى الوظيفى',
        'image'             => 'الصورة',
        'applicant_phone' => 'رقم الهاتف',
        'applicant_email' => 'عنوان البريد الالكترونى',
        'applicant_rcode' => 'كود المنطقة',
        'lat'             => 'الموقع',

        'nationality'    => 'الجنسية',
        'functional_num' => 'الرقم الوظيفى',
        'branch_id'      => 'الفرع',
        'from'           => 'من تاريخ',
        'to'             => 'الى تاريخ',
        'fueltype'       => 'نوع الوقود',
        ...
        'subuser'        => 'المستخدم الفرعى',
        'order_id'       => 'الفاتورة',
        'orderdate'      => 'تاريخ الفاتورة',
        'liters'         => 'عدد اللترات',
        'name_ar'        => 'الاسم بالعربية',
        'name_en'        => 'الاسم بالانجليزية',
        'alert_before_appoinment_type' => 'نوع التنبيه قبل الموعد',
        'alert_before_appoinment_type_number' => 'رقم التنبيه قبل الموعد',
        'alert_repeat'    => 'تكرارا المنبه',
        'property_type'  => 'نوع العقار',
        'number_of_property' => 'رقم العقار',
        'rent_of_property'    => 'مقدم الايجار',
